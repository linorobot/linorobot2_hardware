...
Teensy 3.x and 4.x have different mapping of PWM pins, read the notes beside each pin assignment in [lino_base_config.h](https://github.com/linorobot/linorobot2_prototype/blob/master/config/lino_base_config.h#L108) carefully to avoid connecting your driver's PWM pin to a non PWM pin on Teensy. 
